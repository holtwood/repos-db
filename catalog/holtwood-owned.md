...
| [cpp-high-performance-guide](https://github.com/hpc-workbench/cpp-high-performance-guide) | C++ | 性能工程 | 中 | 中 | 可运行的 C++20 性能工程指南：示例、基准、VitePress 文档站 |
| [bitcal](https://github.com/hpc-workbench/bitcal) | C++ | 位运算练习 | 低 | 低 | 头文件 C++23 位运算库，AVX2，实验性 |
...
| [JadeAI](https://github.com/build-workbench/JadeAI) | TypeScript | 求职工具 | 高 | 中 | AI 驱动的简历与求职工作台 |
